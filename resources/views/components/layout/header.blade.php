        ...
        <div class="relative flex items-center justify-between py-5 sm:py-0">
            ...
            <div class="hidden lg:ml-4 lg:flex lg:items-center lg:pr-0.5">
                ...
                <div class="relative ml-4 flex-shrink-0">
                    <div>
                        <button @click="open" type="button" class="flex rounded-full bg-white text-sm ring-2 ring-white ring-opacity-20 focus:outline-none focus:ring-opacity-100" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                    ...
                    <div
                        ...
                        <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-yellow-50" role="menuitem" tabindex="-1" id="user-menu-item-0">Your Profile</a>
                        <hr>
                        <a href="{{ route('logout') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-yellow-50" role="menuitem" tabindex="-1" id="user-menu-item-2">Sign out</a>
                    </div>
                </div>
            </div>
